...
module.exports = {
  ...
  run: async (client, interaction) => {
    const embed = new MessageEmbed()
      ...
      .addField(`Links:`, `- [Discord Server](https://discord.gg/11pm)\n- [GitHub](https://github.com/NOobSsam/Giveawaybot)`, true)
      .setTimestamp()
      .setFooter({
        text: `Requested by ${interaction.user.username} | GiveawayBot™ v3 By z€r0#0911`,
